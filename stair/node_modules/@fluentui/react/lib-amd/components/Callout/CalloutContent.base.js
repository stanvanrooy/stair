                ...
                var timerId_1 = async.requestAnimationFrame(function () {
                    if (hostElement.current && calloutElement) {
                        ...
                        var newPositions = finalHeight
                            ? Positioning_1.positionCard(currentProps, hostElement.current, calloutElement, previousPositions)
                            : Positioning_1.positionCallout(currentProps, hostElement.current, calloutElement, previousPositions);
