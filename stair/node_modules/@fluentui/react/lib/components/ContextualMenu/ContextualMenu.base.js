...
export var ContextualMenuBase = React.memo(React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
    var _a, _b;
    var _c = getPropsWithDefaults(DEFAULT_PROPS, propsWithoutDefaults), ref = _c.ref, props = __rest(_c, ["ref"]);
    ...
    var _d = useTarget(props.target, hostElement), targetRef = _d[0], targetWindow = _d[1];
    ...
    var adjustedFocusZoneProps = __assign(__assign({}, focusZoneProps), { className: classNames.root, isCircularNavigation: true, handleTabKey: FocusZoneTabbableElements.all, direction: (_b = (_a = props.focusZoneProps) === null || _a === void 0 ? void 0 : _a.direction) !== null && _b !== void 0 ? _b : FocusZoneDirection.vertical });
